...
<!--							&lt;!&ndash; Selected: "border-indigo-600 text-indigo-600", Not Selected: "border-transparent text-gray-900" &ndash;&gt;-->
...
<!--					&lt;!&ndash; 'Women' tab panel, show/hide based on tab state. &ndash;&gt;-->
...
<!--						</div>-->
<!--					</div>-->
<!--					&lt;!&ndash; 'Men' tab panel, show/hide based on tab state. &ndash;&gt;-->
...
<!--									<div class="flex">-->
<!--										<div class="relative flex">-->
<!--											&lt;!&ndash; Item active: "text-indigo-600", Item inactive: "text-gray-700 hover:text-gray-800" &ndash;&gt;-->
<!--											<button type="button" class="text-gray-700 hover:text-gray-800 relative flex items-center justify-center text-sm font-medium transition-colors duration-200 ease-out" aria-expanded="false">-->
<!--												Men-->
<!--												&lt;!&ndash; Open: "bg-indigo-600", Closed: "" &ndash;&gt;-->
<!--												<span class="absolute inset-x-0 -bottom-px z-20 h-0.5 transition duration-200 ease-out" aria-hidden="true"></span>-->
<!--											</button>-->
<!--										</div>-->
...
<!--											<div class="absolute inset-0 top-1/2 bg-white shadow" aria-hidden="true"></div>-->
<!--											&lt;!&ndash; Fake border when menu is open &ndash;&gt;-->
<!--											<div class="absolute inset-0 top-0 mx-auto h-px max-w-7xl px-8" aria-hidden="true">-->
<!--												&lt;!&ndash; Open: "bg-gray-200", Closed: "bg-transparent" &ndash;&gt;-->
<!--												<div class="bg-transparent h-px w-full transition-colors duration-200 ease-out"></div>-->
<!--											</div>-->
